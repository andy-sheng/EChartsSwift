// Ported from echarts/theme/macarons.js — keep in sync with upstream.
//
...
// upstream: var colorPalette = [ '#2ec7c9', '#b6a2de', ... ];
private let macaronsPalette: [String] = [
    "#2ec7c9",
    "#b6a2de",
    "#5ab1ef",
    "#ffb980",
...
public enum macaronsTheme {
    public static let theme: [String: Any] = [
        "color": macaronsPalette,
        ...
        "toolbox": [
            "iconStyle": [
                // upstream: borderColor: colorPalette[0]
                "borderColor": "#2ec7c9"
            ]
        ],
