...
//   boilerplate deferred to the slim Orchestrate driver (matches component/grid/installSimple.swift).
...
//   registerPreprocessor) belongs to the later slim Orchestrate driver, not this render-layer file.
