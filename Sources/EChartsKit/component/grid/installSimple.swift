...
public final class GridView: ComponentView {
    ...
    // PORT-TODO: the base `ComponentView.render` signature is (model, ecModel, api, payload); upstream
    ...
    public override func render(
        ...
        if truthy(gridModel.get("show")) {
            ...
            // PORT-TODO: upstream `defaults({fill}, ...)` merges into a dynamic style object which the
            ...
            // PORT-TODO: `coordinateSystem` is typed `CoordinateSystemMaster?` (see GridModel); narrow to
