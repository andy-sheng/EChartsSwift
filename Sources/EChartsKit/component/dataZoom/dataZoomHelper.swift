...
//       -> note: `CoordinateSystemHostModel` is ported (coord/CoordinateSystem.swift); modeled here as its `ComponentModel` supertype.
...
public final class DataZoomReferCoordSysInfo {
    // upstream: model: CoordinateSystemHostModel  -> note: modeled as its `ComponentModel` supertype.
