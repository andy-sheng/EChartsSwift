...
// string-literal union modeled as `String` (values: "markPoint" | "markLine" | "markArea").
public typealias MarkerTypes = String

// type SeriesWithMarkerOption = SeriesOption & Partial<Record<MarkerTypes, unknown>>;
// `SeriesOption` (a typed option interface) is the dynamic option bag `[String: Any]` in
...
// `seriesOpts: SeriesOption | SeriesOption[]` modeled as `Any?` (a dict or an array of
