...
//
// PORT-TODO (sibling-base coupling): this model `extends VisualMapModel`. The following members are
...
//      member below (see `_resetRange`). PORT-TODO: this deviates from upstream's array-property hack.
...
open class ContinuousModel: VisualMapModel {
    ...
    open override func resetItemSize() {
        ...
        // PORT-TODO: upstream treats `itemSize[i] == null` (missing) the same as `isNaN`. The ported
