...
//     PORT-TODO: `getLayoutParams` / `sizeCalculable` are NOT yet in the partial `layout` port
...
//   PORT-TODO: the label-formatter callback param interfaces and `CalendarOption` describe the dynamic
...
public final class CalendarModel: ComponentModel, CoordinateSystemHostModel {
    ...
    //   PORT-TODO: upstream types this the concrete `Calendar` (a `CoordinateSystemMaster`), injected once
...
// PORT-TODO: faithful reproduction of util/layout.ts `getLayoutParams` + `copyLayoutParams({}, source)`
