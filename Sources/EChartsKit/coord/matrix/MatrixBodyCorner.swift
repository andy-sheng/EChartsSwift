...
//   -> MatrixDim.swift (sibling; see PORT-TODO in matrixCoordHelper.swift for the referenced shapes)
...
//
// PORT-TODO: `MatrixDim` (and `MatrixDimPair`, `MatrixXYLocator`, `MatrixXYLocatorRange`) are ported by a
