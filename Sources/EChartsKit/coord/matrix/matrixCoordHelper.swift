...
//   MatrixModel.ts, but MatrixModel.swift deferred them (note) and MatrixDim.swift references
...
// upstream passes the inner one-dim array `locOut[dimIdx]` (a reference) and mutates it in
