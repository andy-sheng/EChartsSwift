...
//     mainType?: 'polar';
// }
//   `PolarOption` describes the dynamic option shape; modeled as the dynamic option bag
...
public final class PolarModel: ComponentModel, CoordinateSystemHostModel {
    ...
    //   upstream types this the concrete `Polar` (a `CoordinateSystemMaster`), injected and
