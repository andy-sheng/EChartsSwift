...
public final class SingleAxisModel: AxisBaseModel, AxisModelExtendedInCreator {
    ...
    //   upstream types this the concrete `Single` (a `CoordinateSystemMaster`), injected by
    ...
    // note (single-axis category support): upstream `SingleAxisModel` gets its `getOrdinalMeta` /
