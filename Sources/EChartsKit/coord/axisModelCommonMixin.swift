...
// import Axis from './Axis';                                           -> Axis  (coord/Axis.swift; PORT-TODO: not yet ported)
// import { AxisBaseOption, ValueAxisBaseOption } from './axisCommonTypes'; -> AxisBaseOption / ValueAxisBaseOption
//     (coord/axisCommonTypes.swift; PORT-TODO: option interfaces not yet ported — dynamic bag used)
// import { CoordinateSystemHostModel } from './CoordinateSystem';      -> CoordinateSystemHostModel
//     (coord/CoordinateSystem.swift, T2; PORT-TODO: not yet ported — typed as `Any?`)

// PORT-TODO: upstream is a mixin (`interface` + `class` declaration-merged, grafted onto axis
...
public protocol AxisModelCommonMixin: AnyObject {
    ...
    // PORT-TODO: coord/Axis.ts not yet ported — typed as `Any` until it lands.
    var axis: Any { get }
}
...
public extension AxisModelCommonMixin {
    ...
    func needIncludeZero() -> Bool {
        ...
        // PORT-TODO: ValueAxisBaseOption not ported — read `scale` from the dynamic option bag.
    ...
    // PORT-TODO: CoordinateSystemHostModel (coord/CoordinateSystem.swift, T2) not yet ported —
    //   typed as `Any?`. Upstream returns `undefined` here; overridden by each axis model.
