// Ported from echarts/src/i18n/langPT-br.ts — keep in sync with upstream.
//
// Language: Portuguese (Brazil). See langEN.swift for the namespace convention.
// The upstream file is `langPT-br.ts` (hyphenated); the Swift enum drops the hyphen
// (`langPTbr`) since it is not a legal identifier. Registered under the locale code
// "PT-br" (registerLocale upper-cases the key → "PT-BR").

// upstream: export default { ... }
public enum langPTbr {
