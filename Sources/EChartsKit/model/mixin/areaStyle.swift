...
// PORT-TODO: `makeStyleMapper` returns the dynamic `Dictionary<Any>` bag (see its port note),
...
// PORT-TODO: TS mixin (applied onto Model subclasses via `this: Model`). Per CONVENTIONS §2
...
public extension AreaStyleMixin where Self: Model {
    func getAreaStyle(
        ...
        // PORT-TODO: module-qualify the file-private mapper closure to disambiguate it from
