...
// return key.
// PORT-TODO: upstream `DiffKeyGetter<CTX>` carries a `this: DataDiffer<CTX>` binding so the
 ...
 * + null/undefined
 */
// PORT-TODO: upstream `{[key: string]: number | number[]}`. Modeled as `[String: Any]`
...
public final class DataDiffer<CTX> {
    ...
    private func _executeOneToOne() {
        ...
        for i in 0..<oldArr.count {
            ...
            if newIdxMapValLen > 1 {
                ...
                // PORT-TODO: upstream `shift()` mutates the array stored in the map in place
    ...
    private func _initIndexMap(
        ...
        // PORT-TODO: upstream passes the key-getter property name ('_oldKeyGetter' |
        ...
        for i in 0..<arr.count {
            ...
            if idxMapValLen == 0 {
                ...
                // PORT-TODO: upstream `push` mutates the array stored in the map in place
