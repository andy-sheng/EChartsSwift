...
open class ComponentView: ViewRootGroup {
    ...
    // PORT-TODO: the caveat above is about upstream's prototype `extend` machinery, which Swift
    ...
    // ----------------------
    // PORT-TODO: upstream declares these non-optional but assigns them after construction
    ...
    //   conforms to `ViewRootGroup`. PORT-TODO: confirm augmentation strategy (see util/types.swift).
     ...
     */
    // PORT-TODO: upstream `cb: (el: Element) => boolean | void`; ZRenderKit `Group.traverse` takes
     ...
     */
    // PORT-TODO: `packedEvent: ECActionEvent | ECElementEvent` union modeled as `Any`. This is a
    ...
    // PORT-TODO: `getClass` is part of the mounted `ClassManager` surface used by the view registry
...
//
// PORT-TODO: no Swift equivalent for the `typeof ComponentView & ExtendableConstructor & ClassManager`
