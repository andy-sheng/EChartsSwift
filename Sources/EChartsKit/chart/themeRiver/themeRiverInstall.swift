...
//       -> `dataFilter` (processor/dataFilter.swift) — the `SERIES_TYPE_THEME_RIVER` processor.
...
//   - registerProcessor:   `dataFilter(SERIES_TYPE_THEME_RIVER)`  // PORT-TODO: processor/dataFilter.ts NOT ported yet
