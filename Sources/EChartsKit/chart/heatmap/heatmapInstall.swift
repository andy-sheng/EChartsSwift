...
//       owned by the slim Orchestrate/Integrate driver (core/EChartsSlim.swift), not this render-layer file.
...
//   (core/EChartsSlim.swift), not this render-layer file (same convention as chart/effectScatter/effectScatterInstall.swift).
