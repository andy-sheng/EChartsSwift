...
// PORT-TODO: interface ExtendedCanvasRenderingContext2D extends CanvasRenderingContext2D { dpr?: number }
...
// PORT-TODO: `typeof Float32Array !== 'undefined'` — runtime feature detection; on the
...
public final class PathProxy {
    ...
    // PORT-TODO: upstream `data: number[] | Float32Array`. Modeled as a single growable
    ...
    // PORT-TODO: private _ctx: ExtendedCanvasRenderingContext2D — renderer-backend context,
    ...
    // PORT-TODO: setContext(ctx) / getContext() operate on a CanvasRenderingContext2D
    //            (renderer seam, not ported — CONVENTIONS §9).

    public func beginPath() -> PathProxy {
        // this._ctx && this._ctx.beginPath();   // PORT-TODO renderer seam §9
        self.reset()
        return self
    }
    ...
    public func moveTo(_ x: Double, _ y: Double) -> PathProxy {
        ...
        // this._ctx && this._ctx.moveTo(x, y);   // PORT-TODO renderer seam §9
    ...
    public func lineTo(_ x: Double, _ y: Double) -> PathProxy {
        ...
        // if (this._ctx && exceedUnit) { this._ctx.lineTo(x, y); }   // PORT-TODO renderer seam §9
        if exceedUnit {
            self._xi = x
            self._yi = y
    ...
    public func bezierCurveTo(_ x1: Double, _ y1: Double, _ x2: Double, _ y2: Double, _ x3: Double, _ y3: Double) -> PathProxy {
        ...
        // if (this._ctx) { this._ctx.bezierCurveTo(x1, y1, x2, y2, x3, y3); }   // PORT-TODO renderer seam §9
        self._xi = x3
        self._yi = y3
        return self
    }
    ...
    public func quadraticCurveTo(_ x1: Double, _ y1: Double, _ x2: Double, _ y2: Double) -> PathProxy {
        ...
        // if (this._ctx) { this._ctx.quadraticCurveTo(x1, y1, x2, y2); }   // PORT-TODO renderer seam §9
        self._xi = x2
        self._yi = y2
        return self
    }
    ...
    public func arc(_ cx: Double, _ cy: Double, _ r: Double, _ startAngle: Double, _ endAngle: Double, _ anticlockwise: Bool? = nil) -> PathProxy {
        ...
        // this._ctx && this._ctx.arc(cx, cy, r, startAngle, endAngle, anticlockwise);   // PORT-TODO renderer seam §9
    ...
    public func arcTo(_ x1: Double, _ y1: Double, _ x2: Double, _ y2: Double, _ radius: Double) -> PathProxy {
        ...
        // if (this._ctx) { this._ctx.arcTo(x1, y1, x2, y2, radius); }   // PORT-TODO renderer seam §9
        return self
    }
    ...
    public func rect(_ x: Double, _ y: Double, _ w: Double, _ h: Double) -> PathProxy {
        ...
        // this._ctx && this._ctx.rect(x, y, w, h);   // PORT-TODO renderer seam §9
    ...
    public func closePath() -> PathProxy {
        ...
        // const ctx = this._ctx;   // PORT-TODO renderer seam §9
        let x0 = self._x0
        let y0 = self._y0
        // if (ctx) { ctx.closePath(); }   // PORT-TODO renderer seam §9
    ...
    // PORT-TODO: fill(ctx)/stroke(ctx) — `ctx` is a CanvasRenderingContext2D (renderer seam,
    //            not ported — CONVENTIONS §9). The `ctx && ctx.fill()/stroke()` call is dropped.
    public func fill() {
        // ctx && ctx.fill();   // PORT-TODO renderer seam §9
        self.toStatic()
    }

    public func stroke() {
        // ctx && ctx.stroke();   // PORT-TODO renderer seam §9
        self.toStatic()
    }
    ...
    public func appendPath(_ path: [PathProxy]) {
        ...
        // PORT-TODO: single ContiguousArray<Double> — always reallocate to exact size.
        if hasTypedArray {
    ...
    private func _drawPendingPt() {
        if self._pendingPtDist > 0 {
            // this._ctx && this._ctx.lineTo(this._pendingPtX, this._pendingPtY);   // PORT-TODO renderer seam §9
            self._pendingPtDist = 0
        }
    }
    ...
    private func _expandData() {
        ...
        // PORT-TODO: upstream converts a static Float32Array back into a growable number[].
    ...
    public func toStatic() {
        ...
        // PORT-TODO: truncate to `_len`. The Float32Array static conversion (which would
        ...
        lo: while i < Int(len) {
            ...
            switch cmd {
                ...
                case CMD.A:
                    ...
                    // PORT-TODO: upstream guards `isEllipse && ctx.ellipse` (feature-detects
