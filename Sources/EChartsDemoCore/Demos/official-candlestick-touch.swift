// official-candlestick-touch — replica of https://echarts.apache.org/examples/zh/editor.html?c=candlestick-touch
// title: Axis Pointer Link and Touch / titleCN: 触屏上的坐标轴指示器
// Mobile-oriented K-line: a candlestick + 3 smoothed MA lines on grid 0, a volume bar series on
// grid 1, the two grids' x-axes linked through `axisPointer.link`, a slider + inside dataZoom, and
// a touch-draggable axisPointer `handle` on the volume axis.
// DEVIATIONS:
//   - The source is TypeScript; webOptionJS is the same JS with the type annotations removed
//     (`type DataItem`, `: DataItem[]`, `: number`, `: Record<string, number>`, `: any`) and the
...
extension EChartsDemoRegistry {
    static let official_candlestick_touch = EChartsDemo(
        ...
        summary: "触屏上的坐标轴指示器 — Axis Pointer Link and Touch",
...
"""#,
        option: [
            "animation": false,
            "color": candlestickTouchColorList,
            "title": [
                "left": "center",
                "text": "Candlestick on Mobile"
            ] as [String: Any],
            ...
            "axisPointer": [
                "link": [
                    ["xAxisIndex": [0.0, 1.0]] as [String: Any]
                ]
            ] as [String: Any],
            "dataZoom": [
                [
            ...
            // The three MA labels are placed by the graphic group but carry no text: the official
            // example only fills them in from an `updateAxisPointer` handler, which lives outside the
            // `option` and therefore outside both panes.
            "graphic": [
                [
                    "type": "group",
                    "left": "center",
                    ...
                    "children": [
                        [
                            ...
                            "type": "text",
                            "style": [
                                "fill": candlestickTouchColorList[1],
                                "font": candlestickTouchLabelFont
                            ] as [String: Any],
                            "left": 0.0
                        ] as [String: Any],
                        [
                            ...
                            "type": "text",
                            "style": [
                                "fill": candlestickTouchColorList[2],
                                "font": candlestickTouchLabelFont
                            ] as [String: Any],
                            "left": "center"
                        ] as [String: Any],
                        [
                            ...
                            "type": "text",
                            "style": [
                                "fill": candlestickTouchColorList[3],
                                "font": candlestickTouchLabelFont
                            ] as [String: Any],
                            "right": 0.0
                        ] as [String: Any]
            ...
            "series": [
                [
                    ...
                    "xAxisIndex": 1.0,
                    "yAxisIndex": 1.0,
                    "itemStyle": ["color": "#7fbe9e"] as [String: Any],
                    "emphasis": [
                        "itemStyle": ["color": "#140"] as [String: Any]
                    ] as [String: Any],
                    "data": candlestickTouchVolumes
                ] as [String: Any],
                [
                    "type": "candlestick",
                    "name": "日K",
                    "data": candlestickTouchData,
                    "itemStyle": [
                        "color": "#ef232a",
                        "color0": "#14b143",
                        "borderColor": "#ef232a",
...
private let candlestickTouchColorList: [String] = [
    "#c23531", "#2f4554", "#61a0a8", "#d48265", "#91c7ae", "#749f83",
    "#ca8622", "#bda29a", "#6e7074", "#546570", "#c4ccd3"
]
private let candlestickTouchLabelFont = "bold 12px Sans-serif"

// Port of the example's `calculateMA`: the mean of the last `dayCount` CLOSE prices (index 1),
// formatted with toFixed(2); the first `dayCount` points have no window and become '-'.
private func candlestickTouchMA(_ dayCount: Int) -> [Any] {
    var result: [Any] = []
    for i in 0..<candlestickTouchData.count {
        if i < dayCount {
            result.append("-")
            continue
        }
        var sum = 0.0
        for j in 0..<dayCount {
            sum += candlestickTouchData[i - j][1]
        }
        result.append(String(format: "%.2f", sum / Double(dayCount)))
    }
    return result
}

private let candlestickTouchMA5: [Any] = candlestickTouchMA(5)
private let candlestickTouchMA10: [Any] = candlestickTouchMA(10)
private let candlestickTouchMA20: [Any] = candlestickTouchMA(20)

private let candlestickTouchDates: [String] = [
    "2016-03-29", "2016-03-30", "2016-03-31", "2016-04-01", "2016-04-04",
    "2016-04-05", "2016-04-06", "2016-04-07", "2016-04-08", "2016-04-11",
    "2016-04-12", "2016-04-13", "2016-04-14", "2016-04-15", "2016-04-18",
    "2016-04-19", "2016-04-20", "2016-04-21", "2016-04-22", "2016-04-25",
    "2016-04-26", "2016-04-27", "2016-04-28", "2016-04-29", "2016-05-02",
    "2016-05-03", "2016-05-04", "2016-05-05", "2016-05-06", "2016-05-09",
    "2016-05-10", "2016-05-11", "2016-05-12", "2016-05-13", "2016-05-16",
    "2016-05-17", "2016-05-18", "2016-05-19", "2016-05-20", "2016-05-23",
    "2016-05-24", "2016-05-25", "2016-05-26", "2016-05-27", "2016-05-31",
    "2016-06-01", "2016-06-02", "2016-06-03", "2016-06-06", "2016-06-07",
    "2016-06-08", "2016-06-09", "2016-06-10", "2016-06-13", "2016-06-14",
    "2016-06-15", "2016-06-16", "2016-06-17", "2016-06-20", "2016-06-21",
    "2016-06-22",
]

// [open, close, lowest, highest, volume] per day.
private let candlestickTouchData: [[Double]] = [
    [17512.58, 17633.11, 17434.27, 17642.81, 86160000.0],
    [17652.36, 17716.66, 17652.36, 17790.11, 79330000.0],
    [17716.05, 17685.09, 17669.72, 17755.7, 102600000.0],
    [17661.74, 17792.75, 17568.02, 17811.48, 104890000.0],
    [17799.39, 17737.0, 17710.67, 17806.38, 85230000.0],
    [17718.03, 17603.32, 17579.56, 17718.03, 115230000.0],
    [17605.45, 17716.05, 17542.54, 17723.55, 99410000.0],
    [17687.28, 17541.96, 17484.23, 17687.28, 90120000.0],
    [17555.39, 17576.96, 17528.16, 17694.51, 79990000.0],
    [17586.48, 17556.41, 17555.9, 17731.63, 107100000.0],
    [17571.34, 17721.25, 17553.57, 17744.43, 81020000.0],
    [17741.66, 17908.28, 17741.66, 17918.35, 91710000.0],
    [17912.25, 17926.43, 17885.44, 17962.14, 84510000.0],
    [17925.95, 17897.46, 17867.41, 17937.65, 118160000.0],
    [17890.2, 18004.16, 17848.22, 18009.53, 89390000.0],
    [18012.1, 18053.6, 17984.43, 18103.46, 89820000.0],
    [18059.49, 18096.27, 18031.21, 18167.63, 100210000.0],
    [18092.84, 17982.52, 17963.89, 18107.29, 102720000.0],
    [17985.05, 18003.75, 17909.89, 18026.85, 134120000.0],
    [17990.94, 17977.24, 17855.55, 17990.94, 83770000.0],
    [17987.38, 17990.32, 17934.17, 18043.77, 92570000.0],
    [17996.14, 18041.55, 17920.26, 18084.66, 109090000.0],
    [18023.88, 17830.76, 17796.55, 18035.73, 100920000.0],
    [17813.09, 17773.64, 17651.98, 17814.83, 136670000.0],
    [17783.78, 17891.16, 17773.71, 17912.35, 80100000.0],
    [17870.75, 17750.91, 17670.88, 17870.75, 97060000.0],
    [17735.02, 17651.26, 17609.01, 17738.06, 95020000.0],
    [17664.48, 17660.71, 17615.82, 17736.11, 81530000.0],
