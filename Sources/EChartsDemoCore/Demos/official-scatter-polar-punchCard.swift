// official-scatter-polar-punchCard — replica of https://echarts.apache.org/examples/zh/editor.html?c=scatter-polar-punchCard
// title: Punch Card of Github / titleCN: GitHub 打卡气泡图（极坐标）
// A scatter series on a polar coordinate system: angleAxis = 24 hours (category, boundaryGap false),
// radiusAxis = 7 weekdays (category, labels rotated 45°), one bubble per (day, hour) whose radius is
// the commit count via a symbolSize closure.
//
...
extension EChartsDemoRegistry {
    static let official_scatter_polar_punchcard = EChartsDemo(
        ...
        summary: "GitHub 打卡气泡图（极坐标） — Punch Card of Github",
...
// [dayIndex, hourIndex, commits] — 7 days × 24 hours.
private let punchCardData: [[Double]] = [
