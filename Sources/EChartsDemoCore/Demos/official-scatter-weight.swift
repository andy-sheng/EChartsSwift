// official-scatter-weight — replica of https://echarts.apache.org/examples/zh/editor.html?c=scatter-weight
// title: Distribution of Height and Weight / titleCN: 男性女性身高体重分布
// Two scatter series (Female / Male) of [height cm, weight kg] on scaled value axes, each carrying a
// dashed markArea over its own data range, max/min markPoints and an average + fixed-x markLine.
// Toolbox (dataZoom + rect/polygon/clear brush) and the `brush` component come along verbatim.
// DEVIATIONS:
...
extension EChartsDemoRegistry {
    static let official_scatter_weight = EChartsDemo(
        ...
        summary: "男性女性身高体重分布 — Distribution of Height and Weight",
            ...
            "series": [
                ...
                [
                    ...
                    "markLine": [
                        ...
                        "data": [
                            ["type": "average", "name": "Average"] as [String: Any],
                            ["xAxis": 170.0] as [String: Any]
                        ]
                    ] as [String: Any]
                ] as [String: Any]
            ]
...
// Swift's type-checker does not have to infer a 507-element heterogeneous nested literal.
private let scatterWeightFemaleData: [[Double]] = [
...
private let scatterWeightMaleData: [[Double]] = [
